...
{
	ft_putstr_fd("\033[1m\033[36m[SO_LONG]\033[0;0m\n", 1);
	ft_putstr_fd("Your goal is to collect every key present on the map, then \
get the chest chosing the shortest possible route.\n", 1);
	ft_putstr_fd("Use AWSD or the arrow keys to move.\n", 1);
	ft_putstr_fd("Good luck!\n\n", 1);
}
